...
public class Originator implements java.io.Serializable
{
   ...
   private com.crossvale.common.CodeValue channel;
   ...
   public com.crossvale.common.CodeValue getChannel()
   {
      return this.channel;
   }

   public void setChannel(com.crossvale.common.CodeValue channel)
   {
   ...
   public Originator(java.lang.String globalId,
         ...
         com.crossvale.common.CodeValue channel, java.lang.String firstName,
         java.lang.String lastName, com.crossvale.common.CodeValue group)
   {
      this.globalId = globalId;
      this.costCenterCode = costCenterCode;
      this.medium = medium;
