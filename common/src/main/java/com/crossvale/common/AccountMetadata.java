...
public class AccountMetadata implements java.io.Serializable
{
   ...
   private com.crossvale.common.Location corporate_location;
   @org.kie.api.definition.type.Label(value = "physical_location")
   private com.crossvale.common.Location physical_location;
   ...
   public com.crossvale.common.Location getCorporate_location()
   {
      return this.corporate_location;
   }

   public void setCorporate_location(
         com.crossvale.common.Location corporate_location)
   {
      this.corporate_location = corporate_location;
   }

   public com.crossvale.common.Location getPhysical_location()
   {
      return this.physical_location;
   }

   public void setPhysical_location(
         com.crossvale.common.Location physical_location)
   {
