...
public class Requestor implements java.io.Serializable
{
   ...
   @org.kie.api.definition.type.Label(value = "vipFlag")
   ...
   @org.kie.api.definition.type.Label(value = "business")
   private java.lang.String business;
   @org.kie.api.definition.type.Label(value = "customerNumber")
   private java.lang.String customerNumber;
   @org.kie.api.definition.type.Label(value = "sourceApp")
   ...
   public Requestor(java.lang.String ssn, java.lang.String vipFlag,
         ...
         java.lang.String sourceApp, com.crossvale.carddispute.CodeValue type)
   {
      this.ssn = ssn;
      this.vipFlag = vipFlag;
      this.firstName = firstName;
