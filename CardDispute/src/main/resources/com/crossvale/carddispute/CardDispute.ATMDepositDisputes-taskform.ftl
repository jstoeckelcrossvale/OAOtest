<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("atmNr");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid atmNr");
							myInputs[j].focus();
							return false;
						}
					j++;
...
<div id="container">
	<div id="header">
		New Process Instance: /CardDispute/src/main/resources/com/crossvale/carddispute.ATMDepositDisputes
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<label for="name">atmNr</label>
                            		<div class="div_texbox">
                              		<input name="atmNr" type="text" class="textbox" id="atmNr" value="" />
                            		</div>
