...
public class ContactMethod implements java.io.Serializable
{
   ...
   private com.crossvale.oao.CodeValue language;
   ...
   public com.crossvale.oao.CodeValue getLanguage()
   {
      return this.language;
   }

   public void setLanguage(com.crossvale.oao.CodeValue language)
   {
   ...
   public ContactMethod(java.lang.String phoneNumber, java.lang.String email,
         ...
         com.crossvale.oao.CodeValue language,
