...
public class Accounts implements java.io.Serializable
{
   ...
   private java.util.List<com.crossvale.oao.Account_routing> account_routing;
   @org.kie.api.definition.type.Label(value = "account_rules")
   private java.util.List<com.crossvale.oao.Account_rules> account_rules;
   ...
   public java.util.List<com.crossvale.oao.Account_routing> getAccount_routing()
   {
      return this.account_routing;
   }

   public void setAccount_routing(
         java.util.List<com.crossvale.oao.Account_routing> account_routing)
   {
      this.account_routing = account_routing;
   }

   public java.util.List<com.crossvale.oao.Account_rules> getAccount_rules()
   {
      return this.account_rules;
   }

   public void setAccount_rules(
         java.util.List<com.crossvale.oao.Account_rules> account_rules)
   {
      this.account_rules = account_rules;
   }

   public Accounts(java.lang.String customerNumber, java.lang.String status,
         java.lang.String label, com.crossvale.oao.Balance balance,
